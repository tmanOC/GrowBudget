...
urlpatterns = [
    ...
    path('all-balances/', views.FullAllBalanceDetailView.as_view(), name='full-balances'),
    path('interest/<int:pk>/', views.IndividualAccountDetailView.as_view(), name='individual-interest'),
